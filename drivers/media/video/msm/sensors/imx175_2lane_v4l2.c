...
static struct msm_sensor_exp_gain_info_t imx175_exp_gain_info = {
	...
	.vert_offset = 5, /* sony imx175 sensor limitation */ /* HTC Tom 20120210 - Fix black screen */
	.min_vert = 4, /* min coarse integration time */ /* HTC Angie 20111019 - Fix FPS */	
	.sensor_max_linecount = 65530,
};
...
static const char *imx175NAME = "imx105";
...
{
	struct msm_sensor_ctrl_t *s_ctrl = &imx175_s_ctrl;
	int rc = 0;
		...
		struct msm_sensor_ctrl_t *s_ctrl)
{
	...
	for (info_index = 0; info_index < 10; info_index++) {
		rc = msm_camera_i2c_write_b(imx175_msm_camera_i2c_client ,0x34C9, info_index);
		if (rc < 0)
		...
		rc = msm_camera_i2c_read(imx175_msm_camera_i2c_client,0x3500, &info_value,2);
		if (rc < 0)
	...
	cdata->cfg.fuse.fuse_id_word4 =
		...
		(OTP[9]);
	/*
	   pr_info("[CAM]imx175: fuse->fuse_id_word1:%d\n",
	   cdata->cfg.fuse.fuse_id_word1);
	   pr_info("[CAM]imx175: fuse->fuse_id_word2:%d\n",
	   cdata->cfg.fuse.fuse_id_word2);
	   pr_info("[CAM]imx175: fuse->fuse_id_word3:0x%08x\n",
	   cdata->cfg.fuse.fuse_id_word3);
	   pr_info("[CAM]imx175: fuse->fuse_id_word4:0x%08x\n",
	   cdata->cfg.fuse.fuse_id_word4);
	   */		
...
static struct msm_sensor_fn_t imx175_func_tbl = {
	...
	.sensor_write_exp_gain_ex = msm_sensor_write_exp_gain01_ex,
	.sensor_write_snapshot_exp_gain_ex = msm_sensor_write_exp_gain01_ex,
	.sensor_set_dig_gain = imx175_set_dig_gain,
	.sensor_write_snapshot_exp_gain = msm_sensor_write_exp_gain01,
