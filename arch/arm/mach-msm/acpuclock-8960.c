...
{
	unsigned *status = (unsigned *)(CPU_FOOT_PRINT_BASE_CPU0_VIRT + 0x72) + cpu;
...
{
	unsigned *status = (unsigned *)(CPU_FOOT_PRINT_BASE_CPU0_VIRT + 0x5E) + cpu;
	*status = khz;
	mb();
}
...
{
	unsigned *status = (unsigned *)(CPU_FOOT_PRINT_BASE_CPU0_VIRT + 0x6C);
	*status = khz;
	mb();
}
...
static unsigned int hfpll_vdd_tbl_8960[] = {
	[HFPLL_VDD_NONE] = 0,
	[HFPLL_VDD_LOW]  = 800000,
	[HFPLL_VDD_NOM]  = 950000
};
...
static struct l2_level l2_freq_tbl_8960_kraitv2[] = {
	...
	[3]  = { {  432000, HFPLL, 2, 0, 0x20 }, 1050000, 1050000, 3 },
	[4]  = { {  486000, HFPLL, 2, 0, 0x24 }, 1050000, 1050000, 3 },
	[5]  = { {  540000, HFPLL, 2, 0, 0x28 }, 1050000, 1050000, 3 },
	[6]  = { {  594000, HFPLL, 1, 0, 0x16 }, 1050000, 1050000, 4 },
	...
	[18] = { { 1242000, HFPLL, 1, 0, 0x2E }, 1150000, 1150000, 7 },
	[19] = { { 1296000, HFPLL, 1, 0, 0x30 }, 1150000, 1150000, 7 },
	[20] = { { 1350000, HFPLL, 1, 0, 0x32 }, 1150000, 1150000, 7 },
	[21] = { { 1404000, HFPLL, 1, 0, 0x34 }, 1150000, 1150000, 7 },	
	[22] = { { 1458000, HFPLL, 1, 0, 0x36 }, 1150000, 1150000, 7 },
};
...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_slow[] = {
	...
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(2),   900000 },
	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(4),   950000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(4),   950000 },
	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(4),  1000000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(8),  1000000 },
	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(8),  1025000 },
	{ 1, {   702000, HFPLL, 1, 0, 0x1A }, L2(8),  1025000 },
	{ 0, {   756000, HFPLL, 1, 0, 0x1C }, L2(8),  1075000 },
	{ 1, {   810000, HFPLL, 1, 0, 0x1E }, L2(8),  1075000 },
	{ 0, {   864000, HFPLL, 1, 0, 0x20 }, L2(11), 1100000 },
	{ 1, {   918000, HFPLL, 1, 0, 0x22 }, L2(11), 1100000 },
	{ 0, {   972000, HFPLL, 1, 0, 0x24 }, L2(11), 1125000 },
	{ 1, {  1026000, HFPLL, 1, 0, 0x26 }, L2(11), 1125000 },
	{ 0, {  1080000, HFPLL, 1, 0, 0x28 }, L2(11), 1175000 },
	{ 1, {  1134000, HFPLL, 1, 0, 0x2A }, L2(11), 1175000 },
	{ 0, {  1188000, HFPLL, 1, 0, 0x2C }, L2(11), 1200000 },
	{ 1, {  1242000, HFPLL, 1, 0, 0x2E }, L2(11), 1200000 },
	{ 0, {  1296000, HFPLL, 1, 0, 0x30 }, L2(18), 1225000 },
	{ 1, {  1350000, HFPLL, 1, 0, 0x32 }, L2(18), 1225000 },
	{ 0, {  1404000, HFPLL, 1, 0, 0x34 }, L2(18), 1225000 },
	{ 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(18), 1225000 },
	{ 1, {  1512000, HFPLL, 1, 0, 0x38 }, L2(22), 1250000 },
	{ 1, {  1566000, HFPLL, 1, 0, 0x3A }, L2(22), 1250000 },
	{ 1, {  1620000, HFPLL, 1, 0, 0x3C }, L2(22), 1275000 },
	{ 1, {  1674000, HFPLL, 1, 0, 0x3E }, L2(22), 1275000 },	
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_nom[] = {
	...
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(2),   850000 },
	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(4),   900000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(4),   900000 },
	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(4),   950000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(8),   950000 },
	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(8),   975000 },
	{ 1, {   702000, HFPLL, 1, 0, 0x1A }, L2(8),   975000 },
	{ 0, {   756000, HFPLL, 1, 0, 0x1C }, L2(8),  1025000 },
	{ 1, {   810000, HFPLL, 1, 0, 0x1E }, L2(8),  1025000 },
	...
	{ 0, {  1080000, HFPLL, 1, 0, 0x28 }, L2(11), 1125000 },
	{ 1, {  1134000, HFPLL, 1, 0, 0x2A }, L2(11), 1125000 },
	{ 0, {  1188000, HFPLL, 1, 0, 0x2C }, L2(11), 1150000 },
	{ 1, {  1242000, HFPLL, 1, 0, 0x2E }, L2(11), 1150000 },
	{ 0, {  1296000, HFPLL, 1, 0, 0x30 }, L2(18), 1175000 },
	{ 1, {  1350000, HFPLL, 1, 0, 0x32 }, L2(18), 1175000 },
	{ 0, {  1404000, HFPLL, 1, 0, 0x34 }, L2(18), 1175000 },
	{ 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(18), 1175000 },
	{ 1, {  1512000, HFPLL, 1, 0, 0x38 }, L2(22), 1200000 },
	{ 1, {  1566000, HFPLL, 1, 0, 0x3A }, L2(22), 1200000 },
	{ 1, {  1620000, HFPLL, 1, 0, 0x3C }, L2(22), 1225000 },
	{ 1, {  1674000, HFPLL, 1, 0, 0x3E }, L2(22), 1225000 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_fast[] = {
	{ 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   800000 },
	{ 1, {   192000, PLL_8, 0, 2, 0x00 }, L2(1),   800000 },
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(2),   800000 },
	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(4),   850000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(4),   850000 },
	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(4),   900000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(8),   900000 },
	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(8),   925000 },
	{ 1, {   702000, HFPLL, 1, 0, 0x1A }, L2(8),   925000 },
	{ 0, {   756000, HFPLL, 1, 0, 0x1C }, L2(8),   975000 },
	{ 1, {   810000, HFPLL, 1, 0, 0x1E }, L2(8),   975000 },
	...
	{ 0, {  1080000, HFPLL, 1, 0, 0x28 }, L2(11), 1075000 },
	{ 1, {  1134000, HFPLL, 1, 0, 0x2A }, L2(11), 1075000 },
	{ 0, {  1188000, HFPLL, 1, 0, 0x2C }, L2(11), 1100000 },
	{ 1, {  1242000, HFPLL, 1, 0, 0x2E }, L2(11), 1100000 },
	{ 0, {  1296000, HFPLL, 1, 0, 0x30 }, L2(18), 1125000 },
	{ 1, {  1350000, HFPLL, 1, 0, 0x32 }, L2(18), 1125000 },
	{ 0, {  1404000, HFPLL, 1, 0, 0x34 }, L2(18), 1125000 },
	{ 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(18), 1125000 },
	{ 1, {  1512000, HFPLL, 1, 0, 0x38 }, L2(22), 1150000 },
	{ 1, {  1566000, HFPLL, 1, 0, 0x3A }, L2(22), 1150000 },
	{ 1, {  1620000, HFPLL, 1, 0, 0x3C }, L2(22), 1175000 },
	{ 1, {  1674000, HFPLL, 1, 0, 0x3E }, L2(22), 1175000 },
	{ 0, { 0 } }
};
